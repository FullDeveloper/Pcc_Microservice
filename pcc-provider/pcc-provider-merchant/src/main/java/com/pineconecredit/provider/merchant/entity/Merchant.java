...
private static final long serialVersionUID=1L;
    ...
    private String otherMaterial;
        ...
        //审核状态 0:未审核 1:审核通过正常 2:审核不通过 3:该商户被禁停,此时如果AID未禁止那么仍然允许登陆
     ...
     * 设置：营业执照代码
     */
    public void setLicenseNumber(String licenseNumer) {
            this.licenseNumber = licenseNumer;
    }
    /**
     * 获取：营业执照代码
     */
 ...
 3:该商户被禁停,此时如果AID未禁止那么仍然允许登陆
     ...
     * 获取：管理员身份证反面扫描件
     */
    public String getAdminIdCardReverseSacen() {
